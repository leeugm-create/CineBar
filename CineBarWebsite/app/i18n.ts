...
export const messages: Record<Locale, Messages> = {
  "zh-Hans": {
    ...
    heroVersion: "CineBar for macOS · 0.9.0-test.1（Build 129）测试版",
    heroTitle1: "找到",
    heroTitle2: "下一部好片",
    ...
    tvLiveSource: "直播源",
    tvStationCount: "个电视台",
  tvSignalUnavailable: "信号暂不可用",
    today: "每日推荐",
    trending: "今日热门",
    aiSearch: "AI 找电影",
    trendingMovies: "今日热门电影",
    trendingShows: "今日热门电视",
    watchlist: "我的片单",
    dailyRec: "每日推荐",
    dailyBy: "根据你的类型与地区偏好",
  ...
  "zh-Hant": {
    metaTitle: "CineBar — 找到下一部好片",
    heroVersion: "CineBar for macOS · 0.9.0-test.1（Build 129）測試版",
    heroTitle1: "找到",
    heroTitle2: "下一部好片",
    ...
    tvLiveSource: "直播源",
    tvStationCount: "個電視台",
  tvSignalUnavailable: "訊號暫時不可用",
    today: "每日推薦",
    trending: "今日熱門",
    aiSearch: "AI 找電影",
    trendingMovies: "今日熱門電影",
    trendingShows: "今日熱門電視",
    watchlist: "我的片單",
    dailyRec: "每日推薦",
    dailyBy: "根據你的類型與地區偏好",
  ...
  en: {
    ...
    heroVersion: "CineBar for macOS · 0.9.0-test.1 (Build 129) Beta",
  ...
  tvSignalUnavailable: "Signal unavailable",
    today: "Daily Picks",
    trending: "Trending today",
    aiSearch: "AI Find a Movie",
    trendingMovies: "Today trending movies",
    trendingShows: "Today trending TV",
    ...
    features: [
      ["Discover", "Trending today, daily picks, opening soon and airing today."],
  ...
  ja: {
    ...
    heroVersion: "CineBar for macOS · 0.9.0-test.1（Build 129）テスト版",
    heroTitle1: "次の名作を",
    heroTitle2: "見つけよう",
    ...
    tvLiveSource: "ライブ配信元",
    tvStationCount: "局",
  tvSignalUnavailable: "信号を利用できません",
    today: "今日のおすすめ",
    trending: "今日のトレンド",
    aiSearch: "AIで映画を探す",
    trendingMovies: "今日の注目映画",
    trendingShows: "今日の注目テレビ",
    watchlist: "マイリスト",
    dailyRec: "今日のおすすめ",
    ...
    features: [
      ["発見", "今日のトレンド、今日のおすすめ、まもなく公開、今日の放送分。"],
  ...
  ko: {
    ...
    heroVersion: "CineBar for macOS · 0.9.0-test.1 (Build 129) 베타",
    heroTitle1: "다음 볼",
    ...
    tvLiveSource: "라이브 소스",
    tvStationCount: "개 채널",
  tvSignalUnavailable: "신호를 사용할 수 없음",
    today: "오늘의 추천",
    trending: "오늘 인기",
    aiSearch: "AI로 영화 찾기",
    trendingMovies: "오늘 인기 영화",
    trendingShows: "오늘 인기 TV",
    watchlist: "내 목록",
    dailyRec: "오늘의 추천",
