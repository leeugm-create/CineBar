...
export const messages: Record<Locale, Messages> = {
  "zh-Hans": {
    ...
    heroVersion: "CineBar for macOS · 0.9.0-test.1（Build 87）测试版",
    heroTitle1: "找到",
    heroTitle2: "下一部好片",
  ...
  "zh-Hant": {
    metaTitle: "CineBar — 找到下一部好片",
    heroVersion: "CineBar for macOS · 0.9.0-test.1（Build 87）測試版",
    heroTitle1: "找到",
    heroTitle2: "下一部好片",
  ...
  en: {
    ...
    heroVersion: "CineBar for macOS · 0.9.0-test.1 (Build 87) Beta",
  ...
  ja: {
    ...
    heroVersion: "CineBar for macOS · 0.9.0-test.1（Build 87）テスト版",
    heroTitle1: "次の名作を",
    heroTitle2: "見つけよう",
  ...
  ko: {
    ...
    heroVersion: "CineBar for macOS · 0.9.0-test.1 (Build 87) 베타",
    heroTitle1: "다음 볼",
