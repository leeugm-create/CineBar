...
export const messages: Record<Locale, Messages> = {
  "zh-Hans": {
    ...
    heroVersion: "CineBar for macOS · 0.8.3-test.15（Build 50）测试版",
    heroTitle1: "找到",
    heroTitle2: "下一部好片",
    ...
    steps: [
      "从上方 Build 50 固定地址下载测试包并解压，把 CineBar.app 移入“应用程序”文件夹。",
  ...
  "zh-Hant": {
    metaTitle: "CineBar — 找到下一部好片",
    heroVersion: "CineBar for macOS · 0.8.3-test.15（Build 50）測試版",
    heroTitle1: "找到",
    heroTitle2: "下一部好片",
    ...
    steps: [
      "從上方 Build 50 固定連結下載測試包並解壓，把 CineBar.app 移入「應用程式」資料夾。",
  ...
  en: {
    ...
    heroVersion: "CineBar for macOS · 0.8.3-test.15 (Build 50) Beta",
    ...
    steps: [
      "Download and unzip the beta from the fixed Build 50 link above, then move CineBar.app into your Applications folder.",
  ...
  ja: {
    ...
    heroVersion: "CineBar for macOS · 0.8.3-test.15（Build 50）テスト版",
    heroTitle1: "次の名作を",
    heroTitle2: "見つけよう",
    ...
    steps: [
      "上記の固定リンク（Build 50）からテスト版をダウンロードして解凍し、CineBar.app を Applications フォルダに移します。",
  ...
  ko: {
    ...
    heroVersion: "CineBar for macOS · 0.8.3-test.15 (Build 50) 베타",
    heroTitle1: "다음 볼",
    ...
    steps: [
      "위의 고정 링크(Build 50)에서 테스트 버전을 다운로드해 압축을 풀고, CineBar.app을 응용 프로그램 폴더로 옮깁니다.",
